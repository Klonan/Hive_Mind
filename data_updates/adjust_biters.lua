...
local make_biter_item = function(prototype, subgroup)
  local item =
  {
    ...
    localised_description = {"requires-pollution", prototype.pollution_to_join_attack * shared.pollution_recipe_scale},
    icon = prototype.icon,
...
local make_biter_recipe = function(prototype, category)
  local recipe =
  {
    ...
    ingredients = {},
    energy_required = prototype.pollution_to_join_attack * shared.pollution_recipe_scale * shared.pollution_progress_scale,
...
local make_worm_item = function(prototype)
  local item =
  {
    ...
    name = prototype.name,
    localised_name = prototype.localised_name,
    localised_description = {"requires-pollution", shared.required_pollution[prototype.name] * shared.pollution_recipe_scale},
    icon = prototype.icon,
    icon_size = prototype.icon_size,
    stack_size = 1,
    order = prototype.order or prototype.name,
...
local make_worm = function(turret)
  ...
  turret.localised_description = {"requires-pollution", shared.required_pollution[turret.name] * shared.pollution_recipe_scale}
